...
我们假设大家都上过《计算概论 A》或《计算概论 B》(C/C++ 描述)，你仍然可以沿用你的编程环境习惯。只需要能够支持C++20的标准即可。
...
![image-20240210180700663](/assets/windows-4.png)
...
1. Microsoft C/C++ Extension (cpptools)：
   ...
   <img src="/assets/windows-5.png" alt="Microsoft C/C++ Extension" style="zoom:80%;" />
...
![Clangd Plugin](/assets/clangd_plugin.png)
   
![CodeLLDB Plugin](/assets/codelldb_plugin.png)

同时：我们比较建议使用CMake或者XMake这种构建工具来组织代码，进行各种配置比较方便。如果你想使用无构建工具辅助的组织形式，我们也在最后给了一个例子。

用VSCode打开一个文件夹后，会出现如下的提示：

<img src="/assets/windows-6.png" alt="image-20240211095642159" style="zoom:50%;" />
...
![CLion Hello](/assets/clion_hello.png)
...
![CLion Start](/assets/clion_start.png)
...
![CLion Main](/assets/clion_main.png)
...
![XCode Run](/assets/xcode_run.png)

我们的课程要求的是C++20标准，XCode默认创建的项目已经设置为了该标准，你也可以通过下图中步骤修改。

![XCode C++ Standard](/assets/xcode_cpp_std.png)
